...
NREL 5.0 MW Baseline Wind Turbine (Onshore) with steady wind
---------------------- SIMULATION CONTROL --------------------------------------
True          Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
       5401   TMax            - Total run time (s)
...
"NRELOffshrBsline5MW_InflowWind_8mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"NRELOffshrBsline5MW_Onshore_AeroDyn15_equilib.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
True          CalcSteady      - Calculate a steady-state periodic operating point before linearization? [unused if Linearize=False] (flag)
      ...
      0.001   TrimTol         - Tolerance for the rotational speed convergence [used only if CalcSteady=True] (-)
       0.01   TrimGain        - Proportional gain for the rotational speed error (>0) [used only if CalcSteady=True] (rad/(rad/s) for yaw or pitch; Nm/(rad/s) for torque)
          ...
          5400.000, 5400.059, 5400.117, 5400.176, 5400.235, 5400.293, 5400.352, 5400.411, 5400.470, 5400.528, 5400.587, 5400.646   LinTimes        - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
